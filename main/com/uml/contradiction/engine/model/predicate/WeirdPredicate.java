...
public class WeirdPredicate implements Predicate {
	...
	/**
	 *	There are 2 input parameters in the list:
	 *		- state (State) that contains entry trigger and belong to class C;
	 *		- message (Message) that targeting to object of class C
	 *	Predicate return true if entry-message appear already before message 
	 *	in that sequence diagram where message appear
	 */
	@Override
